...
mongoose.connect("mongodb+srv://unicorn-internship.imqnv51.mongodb.net/myFirstDatabase", { useNewUrlParser: true, useCreateIndex: true, useUnifiedTopology: true, useFindAndModify: false }, (err) => {
    if (!err) {
...
app.listen(port, () => {
    ...
    getCurrentTime()
    getEndDateTime("2022-06-17T09:00:00")
})
