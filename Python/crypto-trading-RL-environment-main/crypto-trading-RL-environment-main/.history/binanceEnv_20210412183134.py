...
class CryptoTradingEnv(py_environment.PyEnvironment):
    def __init__(self, fee = 0.001, starting_date = "2018-05-29", initial_balance = 10000, look_back_window = 500):
        ...
        ef = pd.read_csv('BTC_Modf.csv') #used to get the sheets in our excel file
        self.dfs = []
        ...
        for sn in ef.sheet_names:
            ...
            self.dfs.append(pd.read_csv("BTC_Modf.csv"), sheet_name = sn))
            print("loaded: "+sn)
            self.moves.append([])
