...
public class Account {
	...
	public void insert(String username, String password, String name, int type, String email, String ID, String phone)
	{
		data.insertuser(username, password, name, type, email, ID, phone);
